        ...
        <main className="flex bg-neutral-950 w-full h-screen justify-between items-center">
            <div className={"flex flex-col justify-center h-full p-6 md:w-1/2 md:items-center"}>
                ...
                <div className="flex flex-col items-center gap-4 my-4 w-full md:w-2/3">
                    <input type="email" placeholder="E-mail" className={"w-full py-2.5 px-2 bg-neutral-800 rounded-md"} />
                ...
                <button className={"border border-rose-500 flex items-center w-full py-2.5 justify-center gap-2 rounded-md text-white bg-gradient-to-r from-pink-600 to-orange-600 font-semibold md:w-2/3 my-6 "}>
                    Ingrese a su cuenta
                </button>
                <div className="mt-16 text-center text-gray-400">
                    <p>
                        ¿Está registrado? <Link href="/login" className={"text-white underline mx-1"}> Ingrese aquí </Link>
                    </p>
                </div>
            </div>
